...
const items = computed(() => clientStore.passengerRows)
...
},
{
  ...
  options: [
    ...
    { label: 'Paid', value: 'paid', selected: true, filter: (val: any) => !isNaN(parseFloat(val.replace(/[^0-9.-]+/g, ''))) }
  ]
}, {
  key: 'nationality',
  label: 'Nationality',
